...
.panel-container {
  ...
  scrollbar-color: var(--border-lit) var(--bg-card);
}
...
.panel-container::-webkit-scrollbar-corner {
  background: var(--bg-card);
}
